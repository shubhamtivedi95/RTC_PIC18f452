...
#define MONTH 0x05
#define YEAR  0x06
void setformat(unsigned char mode);
char ampm_check(unsigned char data);
bool I2C_write(unsigned char Byte);
void DS1307_settime(unsigned char hh, unsigned char min, unsigned char ss, bool status,unsigned char mode);
